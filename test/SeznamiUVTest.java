...
public class SeznamiUVTest {
    ...
    public void testUse() {
        assertEquals("Error: please specify a data structure (use {pv|sk|bst})", uv.processInput("use krneki")); 
    }
    ...
    public void testExists() {
        uv.seznam.add("Hey");
        assertEquals("Element exists", uv.seznam.exists("Hey"));
    }
    @Test
    public void testNotExists(){
        uv.seznam.add("Hello");
        assertEquals("Element doesn't exist", uv.seznam.exists("Hey"));
    }
    */
    ...
    public void testRemove() {
        uv.seznam.add("test");
        assertEquals("test",uv.seznam.remove("test"));
    }
