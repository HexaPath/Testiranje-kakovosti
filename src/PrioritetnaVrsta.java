...
public class PrioritetnaVrsta<Tip extends Comparable> implements Seznam<Tip> {
    ...
    private Object[] heap;
    private int end = 0;
    private List<Tip> ListaPrioritetneVrste;
    ...
    public PrioritetnaVrsta(int maxSize) {
        ...
        ListaPrioritetneVrste = new ArrayList<>();
    }
    ...
    public List<Tip> asList() {
        ListaPrioritetneVrste.clear();
        for (int i = 0; i < end; i++) {
            Tip elt = (Tip) heap[i];
            ListaPrioritetneVrste.add(elt);
        }
        return ListaPrioritetneVrste;
    }
